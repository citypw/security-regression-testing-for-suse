...
int main(int argc, char **argv)
{
	...
	struct stat st;
	pid_t pid = 0;
        /* Shawn: according to the CVE desc, this is the point */
	char *env[] = {
	...
	char me[0x1000];
        ...
        /* shawn: if root user is executing.. */
	if (geteuid() == 0 && argc > 1) {
